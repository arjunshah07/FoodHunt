    ...
    >
      {({ isSubmitting }) => (
        <Form className="border border-gray shadow basis-[500px] h-[400px] m-auto flex items-center justify-center flex-col gap-3 mob:basis-[300px] mob:h-[360px]">
          <span className="text-blue-dark text-lg font-extrabold mob:text-sm">{"Welcome to Insta Food. "} Please Login!</span>
          ...
          <div className="flex justify-center p-2.5">
            ...
            <Field type="email" name="email" id="email" className="outline-none  bg-gray-200 p-1 text-sm h-10 w-[200px] rounded-md bg-gray mob:w-[180px] mob:h-8" 
            />
          </div>
          ...
          <div className="pwd flex justify-center p-2.5">
            ...
            <Field type="password" name="password" id="pwd" className="outline-none p-1 bg-gray-200 text-sm h-10 w-[200px] rounded-md bg-gray mob:w-[180px] mob:h-8" />
          </div>
          <ErrorMessage name="password" component="div" className="error-text"/>

          <div className='submit' flex items-center justify-center bg-gray-100>
            <button className="soft-btn px-6 py-3 rounded-lg text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75 transition ease-in-out duration-200 shadow-md hover:shadow-lg w-[100px] " onSubmit={isSubmitting}>
              Submit
            </button>
          </div>
